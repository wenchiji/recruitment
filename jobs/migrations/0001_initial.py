# Generated by Django 2.2.5 on 2021-05-17 14:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.SmallIntegerField(choices=[(2, '运营类'), (3, '设计类'), (0, '技术类'), (1, '产品类')], verbose_name='职位级别')),
                ('job_name', models.CharField(max_length=250, verbose_name='职位名称')),
                ('job_city', models.SmallIntegerField(choices=[(0, '北京'), (1, '上海'), (3, '深圳'), (2, '广州')], verbose_name='工作地点')),
